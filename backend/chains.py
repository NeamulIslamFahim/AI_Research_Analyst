...
RESEARCH_PROMPT = PromptTemplate(
    ...
    template=(
        ...
        "- summary_full_paper MUST be written as 3 to 5 complete sentences in this order: what the paper is about, what problem it solves, what approach it takes, how impactful the approach is, and one short closing sentence.\n"
        "- proposed_model_or_approach MUST be written as 3 to 5 complete sentences focused on methodology. It should describe the method or model used, mention datasets or study samples when explicitly available, and explain the evaluation setup in cautious language when details are limited.\n"
